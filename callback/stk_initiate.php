...
function generateOrder(){
  ...
  //echo substr($order_ref, 1,10);
  $_SESSION['order_ref'] = substr($order_ref, 1,10);
}
generateOrder();
...
if (isset($_POST['phone_no']) && isset($_POST['amount']) && !empty($_POST['phone_no'])) {
  ...
  */
  ...
  $AccountReference = $_SESSION['order_ref'];
